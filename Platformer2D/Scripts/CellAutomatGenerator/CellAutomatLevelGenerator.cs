...
{
    internal sealed class CellAutomatLevelGenerator
    {
        ...
        private int _mapStartPositionX;
        private int _mapStartPositionY;
        ...
        public CellAutomatLevelGenerator(CellAutomatGenerateLevelView generateLevelView)
        {
            ...
            _borders = generateLevelView.Borders;
            _mapStartPositionX = (int)generateLevelView.MapStartPosition.x;
            _mapStartPositionY = (int)generateLevelView.MapStartPosition.y;
        ...
        private void DrawTilesOnMap()
        {
            ...
            for (var x = 0; x < _widthMap; x++)
            {
                for (var y = 0; y < _heightMap; y++)
                {
                    var positionTile = new Vector3Int(_mapStartPositionX + x, _mapStartPositionY - y, 0);
