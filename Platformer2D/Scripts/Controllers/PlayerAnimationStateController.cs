...
{
    internal sealed class PlayerAnimationStateController : IExecute
    {
        ...
        public PlayerAnimationStateController(ObjectView playerObjectView, ContactsPoller contactsPoller)
        {
            _playerObjectView = playerObjectView;
            _contactsPoller = contactsPoller;
            var animationConfig = _playerObjectView.SpriteAnimationConfig;
